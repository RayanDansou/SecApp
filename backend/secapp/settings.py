...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='secapp'),
        'USER': config('DB_USER', default='secapp_user'),
        'PASSWORD': config('DB_PASSWORD', default='secapp_password'),
